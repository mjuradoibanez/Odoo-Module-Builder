...
-- -----------------------------
INSERT INTO fields (name, technical_name, type, required, unique_field, relation_model, relation_field, relation_module, model_id) VALUES
-- Alumno
('Nombre', 'nombre', 'char', TRUE, TRUE, NULL, NULL, NULL, 1),
('Edad', 'edad', 'integer', FALSE, FALSE, NULL, NULL, NULL, 1),
('Cursos', 'cursos_ids', 'many2many', FALSE, FALSE, 'academia.curso', 'alumnos_ids', 'academia', 1),
-- Curso
('Titulo', 'titulo', 'char', TRUE, TRUE, NULL, NULL, NULL, 2),
('Descripcion', 'descripcion', 'text', FALSE, FALSE, NULL, NULL, NULL, 2),
('Alumnos', 'alumnos_ids', 'many2many', FALSE, FALSE, 'academia.alumno', 'cursos_ids', 'academia', 2),
('Profesor', 'profesor_id', 'many2one', FALSE, FALSE, 'academia.profesor', NULL, 'academia', 2),
-- Profesor
('Nombre', 'nombre', 'char', TRUE, TRUE, NULL, NULL, 'academia', 3),
('Cursos', 'cursos_ids', 'one2many', FALSE, FALSE, 'academia.curso', 'profesor_id', 'academia', 3);
...
INSERT INTO fields (name, technical_name, type, required, unique_field, relation_model, relation_field, relation_module, model_id) VALUES
('RelacionA', 'relaciona_id', 'many2one', FALSE, FALSE, 'moduloa.entidada', NULL, 'moduloa', (SELECT id FROM models WHERE technical_name = 'entidadb'));
...
INSERT INTO fields (name, technical_name, type, required, unique_field, relation_model, relation_field, relation_module, model_id) VALUES
('RelacionD', 'relaciond_ids', 'many2many', FALSE, FALSE, 'modulod.entidadd', 'relacionc_ids', 'modulod', (SELECT id FROM models WHERE technical_name = 'entidadc'));

-- Campo many2many en EntidadD apuntando a EntidadC (bloqueo circular)
INSERT INTO fields (name, technical_name, type, required, unique_field, relation_model, relation_field, relation_module, model_id) VALUES
('RelacionC', 'relacionc_ids', 'many2many', FALSE, FALSE, 'moduloc.entidadc', 'relaciond_ids', 'moduloc', (SELECT id FROM models WHERE technical_name = 'entidadd'));


-- CASO DE PRUEBA: Relación entre módulos estándar y personalizados
INSERT INTO fields (name, technical_name, type, required, unique_field, relation_model, relation_field, relation_module, model_id) VALUES
('Usuario Odoo', 'usuario_id', 'many2one', FALSE, FALSE, 'res.users', NULL, 'base', 1),
('Contacto', 'contacto_id', 'many2one', FALSE, FALSE, 'res.partner', NULL, 'base', 1),
('Evento', 'evento_id', 'many2one', FALSE, FALSE, 'calendar.event', NULL, 'calendar', 1),
('OtroMod', 'otromod_id', 'many2one', FALSE, FALSE, 'otrosmod.entidad', NULL, 'otrosmod', 1);